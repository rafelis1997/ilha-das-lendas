...
export function PlayerScoreChart({ playerNick, playerScores, ...rest }: Props) {
  ...
  return (
    <div
      {...rest}
      className="m-6 flex h-fit w-[80%] flex-col items-center justify-start gap-2 rounded-md bg-violet-600 p-12 px-2 shadow-[8px_8px_0px_theme(colors.lime.500)] md:mt-24 "
    >
      <div className="flex w-full items-center justify-start gap-4 px-6">
        ...
        <div className="h-fit max-w-[450px]">
          <h2
            className={`bg-transparent text-4xl font-extrabold uppercase text-lime-500 [filter:drop-shadow(2px_2px_0px_theme(colors.violet.900))]`}
